...
class BirthdayEntryTest {
    ...
    void validRowIsParsedCorrectly() {
        BirthdayEntry entry = BirthdayEntry.from("Brown,Bobby,10-11-1950,bobby.brown@ilovellamaland.com");
    ...
    void secondValidRowIsParsedCorrectly() {
        BirthdayEntry entry = BirthdayEntry.from("O'Rourke,Betsy,28-02-1900,betsy@heyitsme.com");
    ...
    void wrongColumnNumberThrowsException() {
        Exception e = assertThrows(IllegalArgumentException.class,
                () -> BirthdayEntry.from("O'Rourke,28-02-1900,betsy@heyitsme.com")
        );
    ...
    void wrongDateFormatThrowsException() {
        Exception e = assertThrows(IllegalArgumentException.class,
                () -> BirthdayEntry.from("O'Rourke,Betsy,1900-03-28,betsy@heyitsme.com")
        );
